    ...
    static Date date = new Date();  
		...
		public static  void sendemail() throws IOException {
			...
			try {
				...
				message.setRecipients(Message.RecipientType.CC,InternetAddress.parse("sameer.g@contus.in,santhosh.m@contus.in,naveen.l@contus.in,shanthini.b@contus.in,ramya.k@contus.in"));
